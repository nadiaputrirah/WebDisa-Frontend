...
export default function BannerDestinasi({ setSearch }) {
  return (
    <div>
      <section
      ...
      >
        <div className="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
          <h1 className="mb-8 text-xl font-extrabold tracking-tight leading-none text-white md:text-5xl lg:text-6xl">
            Temukan Destinasi Impianmu di Sini!
          </h1>
          <p className="mb-15 text-lg font-normal text-gray-300 lg:text-xl sm:px-16 lg:px-48">
            Jangan sampai ketinggalan untuk mengeksplorasi destinasi populer
            kami yang menawarkan keindahan alam yang luar biasa!
          </p>
